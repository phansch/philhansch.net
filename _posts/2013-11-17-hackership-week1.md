...
Thursday started off with me forgetting about BetaBreakfast. Luckily, I was still on time to see the demos. The first one was [Somewhere](https://www.somewhere.com/). On Somewhere you can <q>Discover how interesting people around the world actually work.</q> Their mission is to give people a glimpse into other people's work and give them an idea if they want to work there. The second demo was by Makeapoint which aims to provide an alternative to text-based discussion forums.
